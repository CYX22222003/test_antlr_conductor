...
import { LvalueContext } from "./RustParser.js";
...
export class RustVisitor<Result> extends AbstractParseTreeVisitor<Result> {
    ...
    /**
     * Visit a parse tree produced by `RustParser.lvalue`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    ...
    /**
     * Visit a parse tree produced by `RustParser.altExpression`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitAltExpression?: (ctx: AltExpressionContext) => Result;
    /**
